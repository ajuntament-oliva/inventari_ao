    ...
    <div class="col-md-6">
        <div class="panel panel-default">
            <div class="panel-heading">
                <h4 class="panel-title">Modificar Propietari i Dispositiu</h4>
            </div>
            <div class="panel-body">
                <form method="post" action="" novalidate>
                    <div class="form-group">
                        <label for="nom">Nom del Propietari:</label>
                        <input type="text" name="nom" id="nom" class="form-control" value="<?php echo htmlspecialchars($propietari['nom']); ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="cognom">Cognom del Propietari:</label>
                        <input type="text" name="cognom" id="cognom" class="form-control" value="<?php echo htmlspecialchars($propietari['cognom']); ?>" required>
                    </div>
