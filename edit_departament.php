       ...
       <div class="panel-body">
          <form method="post" action="edit_departament.php?id=<?php echo (int)$e_departament['id'];?>" class="clearfix">
            <div class="form-group">
                  ...
                  <input type="name" class="form-control" name="departament-titol" value="<?php echo remove_junk(ucwords($e_departament['departament'])); ?>">
            </div>
            <div class="form-group">
                  <label for="name" class="control-label">Dispostiu</label>
                  <input type="name" class="form-control" name="dispositiu-nom" value="<?php echo remove_junk(ucwords($e_departament['dispositiu'])); ?>">
            </div>
            <div class="form-group">
                  <label for="name" class="control-label">Nom</label>
                  <input type="name" class="form-control" name="nom-persona" value="<?php echo remove_junk(ucwords($e_departament['nom'])); ?>">
            </div>
            <div class="form-group">
                  <label for="name" class="control-label">Cognom</label>
                  <input type="name" class="form-control" name="cognom-persona" value="<?php echo remove_junk(ucwords($e_departament['cognom'])); ?>">
            </div>
